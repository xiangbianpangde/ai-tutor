# notebooklm_google_blog

Source: https://blog.google/innovation-and-ai/technology/ai/notebooklm-google-ai/
...
[ x.com ](https://twitter.com/intent/tweet?text=Introducing%20NotebookLM%20%40google&url=https://blog.google/innovation-and-ai/technology/ai/notebooklm-google-ai/) [ Facebook ](https://www.facebook.com/sharer/sharer.php?caption=Introducing%20NotebookLM&u=https://blog.google/innovation-and-ai/technology/ai/notebooklm-google-ai/) [ LinkedIn ](https://www.linkedin.com/shareArticle?mini=true&url=https://blog.google/innovation-and-ai/technology/ai/notebooklm-google-ai/&title=Introducing%20NotebookLM) [ Mail ](mailto:?subject=Introducing%20NotebookLM&body=Check out this article on the Keyword:%0A%0AIntroducing%20NotebookLM%0A%0AWe’re rolling out NotebookLM, an experimental offering from Google Labs to summarize information, complex ideas and brainstorm new connections.%0A%0Ahttps://blog.google/innovation-and-ai/technology/ai/notebooklm-google-ai/)
...
At Google I/O this year we introduced a number of AI-first experiments in development, including [Project Tailwind](http://notebooklm.google.com/signup) — a new kind of notebook designed to help people learn faster.

Today we’re beginning to roll out Project Tailwind with its new name: [NotebookLM](https://notebooklm.google.com/signup), an experimental offering from Google Labs. It’s our endeavor to reimagine what notetaking software might look like if you designed it from scratch knowing that you would have a powerful language model at its core: hence the LM. It will be immediately available to a small group of users in the U.S. as we continue to refine the product and make it more helpful.
...
NotebookLM is an experimental product, built by a small team in [Google Labs](https://labs.withgoogle.com/).
...
Our team has two goals in mind:
  ...
  * **Roll out this technology responsibly** : Getting feedback directly from you is a critical part of [developing AI responsibly](https://blog.google/technology/ai/google-responsible-ai-io-2023/). We will also use a strict set of safety criteria in alignment with our [AI Principles](https://ai.google/responsibility/principles/) and implement appropriate safeguards before expanding to more users and launching new functionality.
...
We hope that in these early days you give NotebookLM a shot. Sign up to the [waitlist](https://notebooklm.google.com/signup) to try it out!
