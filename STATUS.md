...
> 更新: 2026-06-15（C3 第三波完成：M-008 RAG 引擎 + M-009 教学编排，885 测试全绿，下一步 D2 收束待签核 → C4 / v2 第一波过堂三机制结构性通过 / C1+D1 已签核）
> 流程档位: 标准
...
| 10 策略升级 + 健康监控 + 幻觉检测 | specs/10-策略升级.md | ◐ C3：M-009 教学编排（v1 引擎→REST 会话驱动）；费曼/FSRS/阶段校准/长期记忆/红线编排=C4 | 2026-06-15 |
...
6. **C4 第四波**（下一步）：M-010 费曼 + M-011 FSRS + M-012 阶段校准 + M-013 长期记忆 +
   M-016 红线编排（对应 v2 #10 拆分）。
